  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-stone-900 border border-stone-800 text-white rounded-2xl p-6 sm:p-7 shadow-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-5 pt-4 border-t border-stone-800 text-xs">
          <div
            onClick={() => {
              setSelectedStandardId("ista1a");
              setActiveSubTab("deepdive");
            }}
            className="cursor-pointer bg-stone-800/80 hover:bg-stone-800 p-3 rounded-xl border border-blue-500/30 transition-all hover:border-blue-400 group"
          >
            <div className="flex items-center justify-between mb-1">
              <span className="font-bold text-blue-300 text-sm">ISTA 1A</span>
            ...
            <div className="text-[10px] text-amber-400 mt-2 flex items-center gap-1 group-hover:underline">
              <span>查看步驟與除錯</span>
          ...
          <div
            ...
            className="cursor-pointer bg-stone-800/80 hover:bg-stone-800 p-3 rounded-xl border border-emerald-500/30 transition-all hover:border-emerald-400 group"
          >
            <div className="flex items-center justify-between mb-1">
              <span className="font-bold text-emerald-300 text-sm">ISTA 2A</span>
          ...
          <div
            ...
            className="cursor-pointer bg-stone-800/80 hover:bg-stone-800 p-3 rounded-xl border border-amber-500/30 transition-all hover:border-amber-400 group"
          >
            <div className="flex items-center justify-between mb-1">
              <span className="font-bold text-amber-300 text-sm">ISTA 3A</span>
          ...
          <div
            ...
            className="cursor-pointer bg-stone-800/80 hover:bg-stone-800 p-3 rounded-xl border border-purple-500/30 transition-all hover:border-purple-400 group"
          >
            <div className="flex items-center justify-between mb-1">
              <span className="font-bold text-purple-300 text-sm">ASTM D4169</span>
      ...
      {activeSubTab === "matrix" && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-stone-200 shadow-xs p-5 sm:p-6 space-y-6">
                ...
                <table className="w-full text-left text-xs sm:text-sm border-collapse">
                  <thead>
                    <tr className="bg-stone-100 text-stone-900 border-b border-stone-200 font-bold">
                      <th className="py-3 px-4 w-32 sm:w-40 bg-stone-150/50">比較維度</th>
                      <th className="py-3 px-4 w-1/2 border-l border-stone-200 text-amber-900 bg-amber-50/50">
                        ISTA (國際安全運輸協會)
                      </th>
                      <th className="py-3 px-4 w-1/2 border-l border-stone-200 text-purple-900 bg-purple-50/50">
                        ASTM (美國材料和試驗協會)
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-stone-200 text-stone-800">
                    {CORE_PHILOSOPHY_COMPARISON.map((row, idx) => (
                      <tr key={idx} className="hover:bg-stone-50/80 transition-colors">
                        <td className="py-3.5 px-4 font-bold text-stone-900 bg-stone-50/70 align-top">
                          {row.dimension}
                        </td>
                        <td className="py-3.5 px-4 border-l border-stone-200 leading-relaxed align-top">
                          {row.ista}
                        </td>
                        <td className="py-3.5 px-4 border-l border-stone-200 leading-relaxed align-top">
                          {row.astm}
            ...
            <div className="pt-5 border-t border-stone-200 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
                {/* ASTM D4169 */}
                <div className="bg-stone-50 border border-stone-200 rounded-xl p-4 sm:p-5 space-y-2.5 hover:border-stone-300 transition-colors">
            ...
            <table className="w-full text-left text-xs border-collapse min-w-[760px]">
              <thead>
                <tr className="border-b-2 border-stone-200 bg-stone-50 text-stone-800">
                  <th className="py-3 px-3 font-bold w-36">評估維度</th>
                  <th className="py-3 px-3 font-bold w-52 text-stone-900 border-l border-stone-100">
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                      <span>ISTA 1A (完整性初篩)</span>
                    </div>
                  </th>
                  <th className="py-3 px-3 font-bold w-56 text-stone-900 border-l border-stone-100">
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                      <span>ISTA 2A (部分環境模擬)</span>
                    </div>
                  </th>
                  <th className="py-3 px-3 font-bold w-60 text-stone-900 border-l border-stone-100">
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-amber-500"></span>
              ...
              <tbody className="divide-y divide-stone-100">
                {filteredDimensions.map((dim) => (
                  <tr key={dim.id} className="hover:bg-stone-50/80 transition-colors">
                    <td className="py-3.5 px-3 align-top font-semibold text-stone-900 border-r border-stone-100 bg-stone-50/40">
                      <div>{dim.dimensionName}</div>
                      <div className="text-[10px] text-stone-500 font-mono mt-0.5">
                        {dim.dimensionEn}
                      </div>
                      <span className="inline-block mt-1.5 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-stone-100 text-stone-700 border border-stone-200">
                        {dim.importance}
                      </span>
                    </td>
                    <td className="py-3.5 px-3 align-top text-stone-800 border-r border-stone-100 leading-relaxed">
                      {dim.ista1a}
                    </td>
                    <td className="py-3.5 px-3 align-top text-stone-800 border-r border-stone-100 leading-relaxed">
                      {dim.ista2a}
                    </td>
                    <td className="py-3.5 px-3 align-top text-stone-900 border-r border-stone-100 leading-relaxed font-medium">
                      {dim.ista3a}
                    </td>
                    <td className="py-3.5 px-3 align-top text-stone-800 leading-relaxed">
                      {dim.astm}
                    </td>
                  </tr>
                ))}
          ...
          <div className="bg-white border border-stone-200 border-l-4 border-l-amber-500 p-5 rounded-r-xl shadow-xs text-xs text-stone-800 space-y-2.5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-1 border-b border-stone-100">
              <div className="font-bold flex items-center space-x-1.5 text-sm text-stone-900">
                <Sparkles className="w-4 h-4 text-amber-500" />
                <span>Stanley Black & Decker 結構包裝工程師實務選型方針：</span>
              </div>
              <button
                onClick={() => setActiveSubTab("benchmarks")}
                className="self-start sm:self-auto px-3 py-1 bg-amber-400 hover:bg-amber-300 text-stone-950 font-bold rounded-lg text-[11px] flex items-center space-x-1.5 transition-all shadow-xs"
              >
                <Activity className="w-3.5 h-3.5" />
            ...
            <p className="leading-relaxed text-stone-700">
              • <strong className="text-stone-900">初期打樣快篩</strong>：使用 <strong>ISTA 1A</strong>，以最低成本與時間驗證自鎖卡扣強度與幾何公差。<br />
              • <strong className="text-stone-900">亞洲 GSMA 跨太平洋海運</strong>：必須通過 <strong>ISTA 2A</strong>，特別把關 72 小時極限高溫高濕後瓦楞箱抗壓下陷量（安全係數建議 ≥ 4.5）。<br />
              • <strong className="text-stone-900">電動工具與電商直發 (Amazon / Home Depot Online)</strong>：必須通過 <strong>ISTA 3A</strong> 或 ISTA 6-Amazon，嚴格防範頂載隨機震動導致的馬達金屬件漆面磨損與外箱破角。<br />
              • <strong className="text-stone-900">全美大型通路投標審查 (The Home Depot, Lowe's)</strong>：依客戶規格提供 <strong>ASTM D4169 (DC-13 / Level II)</strong> 權威數據。
            </p>
          </div>
        </div>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-xs space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-stone-500 font-medium">標準檢驗模組對照</span>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs border-collapse min-w-[640px] border border-stone-200 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-stone-50 text-stone-800 border-b border-stone-200 font-bold">
                      <th className="py-2.5 px-3 w-28">測試模組</th>
                      <th className="py-2.5 px-3 w-44 text-stone-900 border-l border-stone-200">
                        <div className="flex items-center gap-1.5">
                          <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                          <span>ISTA 1A (基礎過濾)</span>
                        </div>
                      </th>
                      <th className="py-2.5 px-3 w-48 text-stone-900 border-l border-stone-200">
                        <div className="flex items-center gap-1.5">
                          <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                          <span>ISTA 2A (部分環境)</span>
                        </div>
                      </th>
                      <th className="py-2.5 px-3 w-56 text-stone-900 border-l border-stone-200">
                        <div className="flex items-center gap-1.5">
                          <span className="w-2 h-2 rounded-full bg-amber-500"></span>
                          <span>ISTA 3A (全面模擬)</span>
                        </div>
                      </th>
                      <th className="py-2.5 px-3 text-stone-700 border-l border-stone-200">當前標準要求細節</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-stone-100">
                    <tr className="hover:bg-stone-50/70">
                      <td className="py-3 px-3 font-semibold text-stone-900 bg-stone-50/40">
                        跌落 (Drop)
                      </td>
                      <td className="py-3 px-3 text-stone-800 font-medium border-l border-stone-100">
                        ▶ 基本衝擊：固定高度跌落 10 次
                      </td>
                      <td className="py-3 px-3 text-stone-800 border-l border-stone-100">
                        溫濕度預處理 + 重力調配跌落
                      </td>
                      <td className="py-3 px-3 text-stone-900 font-medium border-l border-stone-100">
                        隨機自由跌落 + 邊角傾倒 + 面衝擊
                      </td>
                      <td className="py-3 px-3 text-stone-700 border-l border-stone-100">
                        強制項目 (基礎強度)
                      </td>
                    </tr>
                  </tbody>
          ...
          <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-stone-100">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[10px] bg-stone-100 text-stone-600 px-2 py-0.5 rounded-full border border-stone-200 font-mono">
                  Micom Laboratories
                </span>
                <span className="text-[10px] bg-stone-100 text-stone-600 px-2 py-0.5 rounded-full border border-stone-200 font-mono">
                  ITM-LAB
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse min-w-[620px] border border-stone-200 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-stone-50 border-b border-stone-200 text-stone-800 font-bold">
                    <th className="py-3 px-3.5 w-36">包裝總重量</th>
                    <th className="py-3 px-3.5 text-stone-900 border-l border-stone-200 w-44">
                      <div className="flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                ...
                <tbody className="divide-y divide-stone-100">
                  <tr className="hover:bg-stone-50/70">
                    <td className="py-3.5 px-3.5 font-semibold text-stone-900 bg-stone-50/30">0 - 10 公斤</td>
                  ...
                  <tr className="hover:bg-stone-50/70">
                    <td className="py-3.5 px-3.5 font-semibold text-stone-900 bg-stone-50/30">10 - 19 公斤</td>
                  ...
                  <tr className="hover:bg-stone-50/70 bg-stone-50/50">
                    ...
                    <td className="py-3.5 px-3.5 font-semibold text-stone-900 border-l border-stone-100">
                      10 次 <span className="text-[11px] font-normal text-stone-600">(1角, 3稜, 6面)</span>
                    </td>
                    <td className="py-3.5 px-3.5 font-semibold text-stone-900 border-l border-stone-100">
                      10 次
                    </td>
                    <td className="py-3.5 px-3.5 font-bold text-stone-950 border-l border-stone-100">
                      17 次 <span className="text-[11px] font-normal text-stone-600">(分為震動前與震動後兩階段)</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="border-l-4 border-stone-800 bg-stone-50/80 border border-stone-200 p-4 rounded-r-xl text-xs space-y-1">
              <div className="font-bold text-stone-900 flex items-center space-x-1.5 text-sm">
                <Quote className="w-4 h-4 text-stone-600" />
                <span>結構設計洞察 (Structural Design Insight)：</span>
              </div>
              <p className="text-stone-800 leading-relaxed italic pl-1">
          ...
          <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-xs space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse min-w-[620px] border border-stone-200 rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y divide-stone-100">
                  <tr className="hover:bg-stone-50/70">
                    <td className="py-3 px-3.5 font-semibold text-stone-900 bg-stone-50/30">震動模式</td>
                    <td className="py-3 px-3.5 text-stone-800 border-l border-stone-100">
                      固定位移 (Fixed Displacement)
                    </td>
                    <td className="py-3 px-3.5 text-stone-900 border-l border-stone-100 font-semibold">
                      隨機震動 (Random Vibration)
                    </td>
                  </tr>
                  <tr className="hover:bg-stone-50/70">
                    <td className="py-3 px-3.5 font-semibold text-stone-900 bg-stone-50/30">位移幅度</td>
                    <td className="py-3 px-3.5 text-stone-800 border-l border-stone-100 font-mono">
                      25.4 mm (1 英寸) 峰對峰值
                    </td>
                    <td className="py-3 px-3.5 text-stone-800 border-l border-stone-100">
                      依據 PSD 功率譜密度曲線調整
                  ...
                  <tr className="hover:bg-stone-50/70">
                    <td className="py-3 px-3.5 font-semibold text-stone-900 bg-stone-50/30">頻率範圍</td>
                    <td className="py-3 px-3.5 text-stone-800 border-l border-stone-100 font-mono">
                      約 2 ~ 5 Hz (低頻)
                    </td>
                    <td className="py-3 px-3.5 text-stone-900 border-l border-stone-100 font-mono font-semibold">
                      1 ~ 200 Hz (廣頻)
                    </td>
                  </tr>
                  <tr className="hover:bg-stone-50/70">
                    <td className="py-3 px-3.5 font-semibold text-stone-900 bg-stone-50/30">震動強度</td>
                    <td className="py-3.5 px-3.5 text-stone-800 border-l border-stone-100 font-mono">
                      總計 14,200 次震動衝擊
                    </td>
                    <td className="py-3 px-3.5 text-stone-900 border-l border-stone-100 space-y-1">
                  ...
                  <tr className="hover:bg-stone-50/70 bg-stone-50/50">
                    <td className="py-3 px-3.5 font-bold text-stone-900">頂部載荷</td>
                    <td className="py-3 px-3.5 text-stone-600 border-l border-stone-100">
                      無
                    </td>
                    <td className="py-3 px-3.5 font-bold text-stone-950 border-l border-stone-100">
                      有 <span className="text-[11px] font-normal text-stone-600">(模擬震動時上方疊加其他貨物)</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="bg-white border border-stone-200 border-l-4 border-l-amber-500 p-5 rounded-xl shadow-xs text-xs text-stone-800 space-y-2">
              <div className="font-bold flex items-center space-x-1.5 text-sm text-stone-900">
                <Sparkles className="w-4 h-4 text-amber-500" />
                <span>Stanley Black & Decker 實務面試關鍵亮點：</span>
              </div>
              <p className="leading-relaxed text-stone-700">
                若面試官問：<strong className="text-stone-900">「1A 跌落高度是 760mm，2A 甚至高達 970mm，而 3A 只有 460mm，這是不是代表 1A/2A 的跌落測試比 3A 更難通過？」</strong><br />
                <strong className="text-stone-900">滿分答法：</strong>「這正是典型的經驗陷阱！1A 與 2A 雖然單次高度高（760~970mm），但只摔 10 次；而 3A 高達 <strong>17 次</strong> 複合反覆衝擊（分為震動前、震動後兩階段），並包含特定面的 <strong>910mm 極端落下</strong>。五金重件在 17 次反覆衝擊下，瓦楞紙板受剪力與壓潰會產生<strong>疲勞累積效應</strong>，使內襯卡榫斷裂或紙托粉化；加上 3A 是帶有<strong>頂載 (Top Load)</strong> 的 <strong>1~200 Hz 廣頻隨機震動（陸運 0.53 Grms / 空運 1.05 Grms）</strong>，因此 3A 的綜合破壞力與真實物流嚴苛度遠高於 1A！」
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {STANDARDS_PROFILES.map((profile) => (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-sm text-stone-900">{profile.name}</span>
                  <span className={`text-[10px] px-1.5 py-0.2 rounded font-semibold ${profile.badgeColor}`}>
                    {profile.level.split(" ")[0]}
                  </span>
                </div>
                <div className="text-[11px] text-stone-500 line-clamp-1">{profile.title}</div>
              </button>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-xs space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-stone-100">
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-semibold border ${selectedProfile.badgeColor}`}>
            ...
            {/* Philosophy Box */}
            <div className="bg-stone-50 rounded-xl p-4 border border-stone-200 text-xs text-stone-700 leading-relaxed space-y-1">
              <span className="font-bold text-stone-900 block text-xs">核心測試哲學 (Core Philosophy)：</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-rose-50 rounded-xl p-4 border border-rose-200 text-xs space-y-2">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {selectedProfile.testSequence.map((seq) => (
                  <div key={seq.step} className="p-3 bg-stone-50 rounded-xl border border-stone-200 text-xs space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-amber-700 bg-amber-100 w-5 h-5 rounded-full flex items-center justify-center text-[10px]">
                        {seq.step}
                      </span>
                    ...
                    <div className="font-bold text-stone-800">{seq.name}</div>
                    <p className="text-stone-600 text-[11px] leading-relaxed">{seq.desc}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              ...
              <div className="bg-stone-50 p-4 rounded-xl border border-stone-200 text-xs space-y-2">
                ...
                <div className="text-rose-700 text-[11px] leading-relaxed">
        ...
        <div className="bg-white rounded-2xl border border-stone-200 shadow-xs p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {FAILURE_DEBUG_CASES.map((item, idx) => (
              <div
                key={idx}
                className="p-5 rounded-xl border border-stone-200 bg-stone-50/40 hover:bg-white hover:border-amber-400 transition-all space-y-3 text-xs"
              >
                <div className="flex items-center justify-between pb-2 border-b border-stone-200">
                  <span className="font-mono font-bold text-amber-800 bg-amber-100 px-2 py-0.5 rounded text-[11px]">
                    {item.standard}
                  </span>
                  <span className="text-stone-400 text-[10px]">Failure Case #{idx + 1}</span>
                </div>

                <div>
                  <h4 className="font-bold text-stone-900 text-sm">{item.failureMode}</h4>
                  <div className="text-[10px] text-stone-500 font-mono mt-0.5">{item.failureEn}</div>
                </div>

                <div className="space-y-2 pt-1">
                  <div className="bg-rose-50 p-3 rounded-lg border border-rose-200 text-rose-950 leading-relaxed">
                    <strong className="text-rose-950 font-bold">根因分析 (Root Cause)：</strong>
                    <p className="mt-0.5 text-stone-800">{item.rootCause}</p>
                  </div>

                  <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-200 text-emerald-950 leading-relaxed">
                    <strong className="text-emerald-950 font-bold">工程改善對策 (Engineering Fix)：</strong>
                    <p className="mt-0.5 text-stone-800">{item.engineeringFix}</p>
                  </div>

                  <div className="bg-amber-50 p-3 rounded-lg border border-amber-200 text-amber-950 leading-relaxed">
                    <strong className="text-amber-950 font-bold">防呆預防設計 (Preventive SOP)：</strong>
                    <p className="mt-0.5 text-stone-800">{item.preventiveDesign}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      {activeSubTab === "interview" && (
        <div className="bg-white rounded-2xl border border-stone-200 shadow-xs p-6 space-y-6">
          ...
          {/* Chinese Pitch Card */}
          <div className="bg-stone-50/80 rounded-xl p-5 border border-stone-200 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <span className="bg-stone-900 text-amber-400 font-bold px-2 py-0.5 rounded text-xs">
                  中文口述擬答 (60 秒 STAR 模板)
                </span>
                <span className="text-xs text-stone-500 font-medium">結構化應對技術深問</span>
              </div>
              <button
                onClick={() => handleCopy(INTERVIEW_SCRIPT_ASTM_ISTA.speechScriptZh, "zh")}
                className="flex items-center space-x-1.5 px-3 py-1 bg-white border border-stone-200 rounded-lg text-xs text-stone-700 hover:border-amber-400 transition-colors"
              >
                {copiedZh ? (
                  <>
            ...
            <div className="bg-white p-4 rounded-lg border border-stone-200 text-xs sm:text-sm text-stone-800 leading-relaxed whitespace-pre-line font-sans">
          ...
          <div className="bg-stone-900 text-white rounded-xl p-5 border border-stone-800 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <span className="bg-amber-400 text-stone-950 font-bold px-2 py-0.5 rounded text-xs uppercase">
                  English Spoken Pitch
                </span>
                <span className="text-xs text-stone-400">Fluently address foreign packaging directors</span>
              </div>
              <button
                onClick={() => handleCopy(INTERVIEW_SCRIPT_ASTM_ISTA.speechScriptEn, "en")}
                className="flex items-center space-x-1.5 px-3 py-1 bg-stone-800 border border-stone-700 rounded-lg text-xs text-stone-300 hover:text-white hover:border-amber-400 transition-colors"
              >
                {copiedEn ? (
                  <>
            ...
            <div className="bg-stone-950 p-4 rounded-lg border border-stone-800 text-xs sm:text-sm text-stone-200 leading-relaxed whitespace-pre-line font-sans">
